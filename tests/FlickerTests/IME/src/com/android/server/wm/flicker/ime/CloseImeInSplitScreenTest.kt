...
/**
 * Test IME window closing transitions within a split-screen environment.
 * To run this test: `atest FlickerTestsIme:CloseImeInSplitScreenTest`
 */
@RequiresDevice
@RunWith(Parameterized::class)
@Parameterized.UseParametersRunnerFactory(FlickerParametersRunnerFactory::class)
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
class CloseImeInSplitScreenTest(flicker: FlickerTest) : BaseTest(flicker) {
    ...
    override val transition: FlickerBuilder.() -> Unit = {
        ...
        transitions {
            // Close the IME by focusing on the secondary.
    ...
    @Presubmit
    @Test
    fun imeWindowBecameInvisible() = flicker.imeWindowBecomesInvisible()

    @Presubmit
    @Test
    fun imeLayerBecomesInvisible() = flicker.imeLayerBecomesInvisible()
