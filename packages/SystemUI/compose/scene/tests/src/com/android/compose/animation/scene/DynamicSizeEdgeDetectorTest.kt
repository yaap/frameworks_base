...
class DynamicSizeEdgeDetectorTest {

    private var dynamicEdgeSizePx = 30

    private val underTest = DynamicSizeEdgeDetector { dynamicEdgeSizePx }
    ...
    fun horizontalEdges() {
        ...
        assertThat(horizontalEdge(31)).isNull()
        assertThat(horizontalEdge(69)).isNull()
        assertThat(horizontalEdge(70)).isEqualTo(Edge.Resolved.Right)
        assertThat(horizontalEdge(100)).isEqualTo(Edge.Resolved.Right)

        dynamicEdgeSizePx = 20

        assertThat(horizontalEdge(0)).isEqualTo(Edge.Resolved.Left)
        assertThat(horizontalEdge(30)).isNull()
        assertThat(horizontalEdge(31)).isNull()
        assertThat(horizontalEdge(69)).isNull()
        assertThat(horizontalEdge(70)).isNull()
        assertThat(horizontalEdge(100)).isEqualTo(Edge.Resolved.Right)
    }
    ...
    fun verticalEdges() {
        ...
        assertThat(verticalEdge(31)).isNull()
        assertThat(verticalEdge(69)).isNull()
        ...
        assertThat(verticalEdge(0)).isEqualTo(Edge.Resolved.Top)
        assertThat(verticalEdge(30)).isNull()
        assertThat(verticalEdge(31)).isNull()
        assertThat(verticalEdge(69)).isNull()
        assertThat(verticalEdge(70)).isNull()
        assertThat(verticalEdge(100)).isEqualTo(Edge.Resolved.Bottom)
    }
}
