...
// NOTE: Inspired by [androidx.compose.animation.animateContentSize], without clipToBounds()
...
fun Modifier.animateContentSizeNoClip(
    ...
    this then SizeAnimationModifierElement(animationSpec, Alignment.TopStart, finishedListener)
