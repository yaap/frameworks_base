...
val Kosmos.largeScreenCaptureParametersInteractor by
    Kosmos.Fixture {
        LargeScreenCaptureParametersInteractor(
            largeScreenSettingsRepository = largeScreenCaptureParametersRepository
        )
    }
