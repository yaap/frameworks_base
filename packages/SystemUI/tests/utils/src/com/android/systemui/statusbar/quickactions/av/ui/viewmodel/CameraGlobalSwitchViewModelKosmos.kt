...
val Kosmos.cameraGlobalSwitchViewModelFactory: CameraGlobalSwitchViewModel.Factory by
    Kosmos.Fixture {
        object : CameraGlobalSwitchViewModel.Factory {
            override fun create(): CameraGlobalSwitchViewModel {
                return CameraGlobalSwitchViewModel(
