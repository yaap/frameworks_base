...
val Kosmos.blurButtonViewModelFactory: BlurButtonViewModel.Factory by
    Kosmos.Fixture {
        object : BlurButtonViewModel.Factory {
            override fun create(setCurrentPage: (PageType) -> Unit): BlurButtonViewModel {
                return BlurButtonViewModel(
