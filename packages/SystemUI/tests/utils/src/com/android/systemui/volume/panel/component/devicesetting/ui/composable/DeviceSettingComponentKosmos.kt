...
val Kosmos.deviceSettingComponentFactory: DeviceSettingComponent.Factory by
    Kosmos.Fixture {
        object : DeviceSettingComponent.Factory {
            override fun create(
                viewModelFactory: () -> DeviceSettingComponentViewModel
            ): DeviceSettingComponent {
                return DeviceSettingComponent(
                    viewModelFactory = viewModelFactory,
                    popupFactory = deviceSettingPopupFactory,
