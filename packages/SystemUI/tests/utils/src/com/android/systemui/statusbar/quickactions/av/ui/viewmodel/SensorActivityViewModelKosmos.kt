...
val Kosmos.sensorActivityViewModelFactory by
    Kosmos.Fixture {
        object : SensorActivityViewModel.Factory {
            override fun create(setCurrentPage: (PageType) -> Unit): SensorActivityViewModel =
