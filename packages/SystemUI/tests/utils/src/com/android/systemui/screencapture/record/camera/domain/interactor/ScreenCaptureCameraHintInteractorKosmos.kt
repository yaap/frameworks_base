...
val Kosmos.screenCaptureCameraHintInteractor: ScreenCaptureCameraHintInteractor by
    Kosmos.Fixture {
        ScreenCaptureCameraHintInteractor(
            prefsInteractor = sharedPreferencesInteractor,
            backgroundContext = testDispatcher,
            coroutineScope = applicationCoroutineScope,
            screenCaptureRecordParametersInteractor = screenCaptureRecordParametersInteractor,
        )
    }
