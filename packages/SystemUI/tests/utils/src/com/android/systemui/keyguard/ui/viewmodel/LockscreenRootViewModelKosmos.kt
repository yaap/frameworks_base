...
val Kosmos.lockscreenRootViewModelFactory by Fixture {
    object : LockscreenRootViewModel.Factory {
        override fun create(): LockscreenRootViewModel {
            return LockscreenRootViewModel(
