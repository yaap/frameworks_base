...
val Kosmos.headsetIconViewModelFactory: HeadsetIconViewModel.Factory by
    Kosmos.Fixture {
        object : HeadsetIconViewModel.Factory {
            override fun create(context: Context) =
                HeadsetIconViewModel(context, wiredAudioDeviceInteractor)
        }
    }
