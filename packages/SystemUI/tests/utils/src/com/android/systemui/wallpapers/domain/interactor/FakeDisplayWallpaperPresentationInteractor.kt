...
class FakeDisplayWallpaperPresentationInteractor : DisplayWallpaperPresentationInteractor {

    val _presentationFactoryFlow = MutableStateFlow(NONE)

    override val presentationFactoryFlow: StateFlow<WallpaperPresentationType> =
        _presentationFactoryFlow
}
