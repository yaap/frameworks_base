...
class LocationButtonViewModelTest : SysuiTestCase() {
    ...
    fun getButtonViewModel_stateExists_returnsViewModel() =
        kosmos.runTest {
            ...
            assertThat(result.paddingLeft).isEqualTo(4.dp)
            assertThat(result.paddingTop).isEqualTo(5.dp)
            assertThat(result.paddingRight).isEqualTo(4.dp)
            assertThat(result.paddingBottom).isEqualTo(5.dp)
