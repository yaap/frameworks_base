...
public class TileAdapter extends RecyclerView.Adapter<Holder> implements TileStateListener {
    ...
    public void onBindViewHolder(final Holder holder, int position) {
        ...
        AccessibilityManager accessibilityManager = mContext.getSystemService(AccessibilityManager.class);
        if (!(accessibilityManager.isTouchExplorationEnabled() && selectable)) {
