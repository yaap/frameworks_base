...
package com.android.systemui.ambient.statusbar.shared.flag

import com.android.systemui.Flags
import com.android.systemui.flags.FlagToken
import com.android.systemui.flags.RefactorFlagUtils

/** Helper for reading or using the ongoing activity chips on dream flag state. */
@Suppress("NOTHING_TO_INLINE")
object OngoingActivityChipsOnDream {
    /** The aconfig flag name */
    const val FLAG_NAME = Flags.FLAG_ONGOING_ACTIVITY_CHIPS_ON_DREAM
    ...
    inline val isEnabled
        get() = Flags.ongoingActivityChipsOnDream()
