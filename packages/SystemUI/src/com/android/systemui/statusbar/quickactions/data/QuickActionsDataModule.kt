...
package com.android.systemui.statusbar.quickactions.data
...
@Module
interface QuickActionsDataModule {
    @Binds
    public fun bindQuickActionChipsRepository(
        impl: QuickActionChipsRepositoryImpl
    ): QuickActionChipsRepository
}
