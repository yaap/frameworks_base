...
package com.android.systemui.statusbar.pipeline.mobile

import com.android.systemui.Flags
import com.android.systemui.flags.FlagToken
import com.android.systemui.flags.RefactorFlagUtils

/** Helper for reading or using the status bar mobile icon kairos flag state. */
@Suppress("NOTHING_TO_INLINE")
object StatusBarMobileIconKairos {
    /** The aconfig flag name */
    const val FLAG_NAME = Flags.FLAG_STATUS_BAR_MOBILE_ICON_KAIROS
    ...
    inline val isEnabled
        get() = Flags.statusBarMobileIconKairos()
