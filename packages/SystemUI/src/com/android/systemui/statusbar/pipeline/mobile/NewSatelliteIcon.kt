...
/** Helper for reading or using the new satellite icon flag state. */
@Suppress("NOTHING_TO_INLINE")
object NewSatelliteIcon {
    /** The aconfig flag name */
    const val FLAG_NAME = Flags.FLAG_NEW_SATELLITE_ICON
