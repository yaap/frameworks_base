...
package com.android.systemui.statusbar.pipeline.battery.shared

import com.android.systemui.Flags
import com.android.systemui.flags.FlagToken
import com.android.systemui.flags.RefactorFlagUtils

/** Helper for reading or using the status bar universal battery data source flag state. */
@Suppress("NOTHING_TO_INLINE")
object StatusBarUniversalBatteryDataSource {
    /** The aconfig flag name */
    const val FLAG_NAME = Flags.FLAG_STATUS_BAR_UNIVERSAL_BATTERY_DATA_SOURCE
    ...
    inline val isEnabled
        get() = Flags.statusBarUniversalBatteryDataSource()
