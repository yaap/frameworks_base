...
/**
 * Helper for reading or using the status bar show icons in secure camera flag state.
 *
 * Also requires the `disable_flags_per_display` flag to be enabled.
 */
@Suppress("NOTHING_TO_INLINE")
object StatusBarShowIconsInSecureCamera {
    /** The aconfig flag name */
    const val FLAG_NAME = Flags.FLAG_STATUS_BAR_SHOW_ICONS_IN_SECURE_CAMERA
