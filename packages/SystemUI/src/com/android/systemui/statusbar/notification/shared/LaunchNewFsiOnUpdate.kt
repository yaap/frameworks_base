...
/** Helper for reading or using the launch new fsi on update flag state. */
@Suppress("NOTHING_TO_INLINE")
object LaunchNewFsiOnUpdate {
    /** The aconfig flag name */
    const val FLAG_NAME = Flags.FLAG_LAUNCH_NEW_FSI_ON_UPDATE
    ...
    inline val isEnabled
        get() = Flags.launchNewFsiOnUpdate()
