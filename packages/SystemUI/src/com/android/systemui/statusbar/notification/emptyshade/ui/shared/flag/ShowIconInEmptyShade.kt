...
package com.android.systemui.statusbar.notification.emptyshade.ui.shared.flag

import com.android.systemui.Flags
import com.android.systemui.flags.FlagToken
import com.android.systemui.flags.RefactorFlagUtils

/** Helper for reading or using the show icon in empty shade flag state. */
@Suppress("NOTHING_TO_INLINE")
object ShowIconInEmptyShade {
    /** The aconfig flag name */
    const val FLAG_NAME = Flags.FLAG_SHOW_ICON_IN_EMPTY_SHADE
    ...
    inline val isEnabled
        get() = Flags.showIconInEmptyShade()
