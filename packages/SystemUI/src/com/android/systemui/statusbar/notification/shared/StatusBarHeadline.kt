...
/** Helper for reading or using the headline in status bar prototype flag state. */
@Suppress("NOTHING_TO_INLINE")
object StatusBarHeadline {
    const val FLAG_NAME = Flags.FLAG_STATUS_BAR_HEADLINE

    /** A token used for dependency declaration */
    val token: FlagToken
        get() = FlagToken(FLAG_NAME, isEnabled)

    /** Is the status bar headline enabled */
    @JvmStatic
    inline val isEnabled
        get() = Flags.statusBarHeadline()
