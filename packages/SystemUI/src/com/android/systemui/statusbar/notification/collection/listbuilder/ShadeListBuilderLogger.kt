...
constructor(
    ...
    fun logGroupPruningSuppressed(buildId: Int, keepingParent: PipelineEntry?) {
        buffer.log(
            TAG,
            INFO,
            {
    ...
    fun logPrunedReasonChanged(buildId: Int, prevReason: String?, newReason: String?) {
        buffer.log(
            TAG,
            INFO,
            {
    ...
    fun logFilterChanged(buildId: Int, prevFilter: NotifFilter?, newFilter: NotifFilter?) {
        buffer.log(
            TAG,
            INFO,
            {
    ...
    fun logSectionChanged(buildId: Int, prevSection: NotifSection?, newSection: NotifSection?) {
        buffer.log(
            TAG,
            INFO,
            {
    ...
    private fun getRankString(entry: PipelineEntry): String {
        ...
        return entry.asListEntry()!!.representativeEntry!!.ranking.rank.toString()
    }
