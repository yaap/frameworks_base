 ...
 */
@SysUISingleton
class StatusBarHideIconsForBouncerManager
@Inject
constructor(
    ...
    private var statusBarWindowStateController: StatusBarWindowStateController? = null
    ...
    private val statusBarWindowStateListener = StatusBarWindowStateListener { state ->
        setStatusBarStateAndTriggerUpdate(state)
    }
    ...
    private fun updateHideIconsForBouncer(animate: Boolean) {
        val hideBecauseApp =
            topAppHidesStatusBar && isOccluded && (statusBarWindowHidden || bouncerShowing)
