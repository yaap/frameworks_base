...
/** Helper for reading or using the broadcast dispatcher custom executor flag state. */
@Suppress("NOTHING_TO_INLINE")
object BroadcastDispatcherCustomExecutor {
    /** The aconfig flag name */
    const val FLAG_NAME = Flags.FLAG_BROADCAST_DISPATCHER_CUSTOM_EXECUTOR
    ...
    inline val isEnabled
        get() = Flags.broadcastDispatcherCustomExecutor()
