...
/** Helper for reading or using the enable top ui controller flag state. */
@Suppress("NOTHING_TO_INLINE")
object TopUiControllerRefactor {
    /** The aconfig flag name */
    const val FLAG_NAME = Flags.FLAG_ENABLE_TOP_UI_CONTROLLER
    ...
    inline val isEnabled
        get() = Flags.enableTopUiController()
