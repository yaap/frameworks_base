...
import android.provider.Settings.System.LOCKSCREEN_WEATHER_LOCATION
import android.provider.Settings.System.LOCKSCREEN_WEATHER_TEXT
...
class WeatherViewController(
    ...
    fun setActivityStarter(starter: ActivityStarter) {
    ...
    private fun getSystemSetting(setting: String, defaultValue: Int = 0) =
        getSystemSettingValue(setting, defaultValue) != 0
