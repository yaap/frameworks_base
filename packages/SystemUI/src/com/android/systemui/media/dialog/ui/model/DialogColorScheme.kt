...
/**
 * Data class containing a color scheme to render the Output Switcher dialog in. Definitions are
 * based on GM3 color system go/gm3-color-system.
 */
data class DialogColorScheme(
