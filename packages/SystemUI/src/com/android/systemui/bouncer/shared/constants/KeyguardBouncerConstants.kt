...
object PatternBouncerConstants {
    object ColorId {
        @JvmField val dotColor = colors.materialColorOnSurface
...
object PinBouncerConstants {
    ...
    object Color {
        @JvmField val hintDot = colors.materialColorOnSurface
        @JvmField val shape = colors.materialColorOnSurface
        ...
        @JvmField val action = c(old = NUM_PAD_BUTTON, new = colors.materialColorOnSurface)
    }
