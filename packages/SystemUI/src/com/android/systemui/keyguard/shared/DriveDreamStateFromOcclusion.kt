...
import android.service.dreams.Flags.driveDreamStateFromOcclusion
import com.android.systemui.flags.FlagToken
import com.android.systemui.flags.RefactorFlagUtils

/** Helper for reading or using the [FLAG_DRIVE_DREAM_STATE_FROM_OCCLUSION] state. */
@Suppress("NOTHING_TO_INLINE")
object DriveDreamStateFromOcclusion {
    /** The aconfig flag name */
    const val FLAG_NAME = FLAG_DRIVE_DREAM_STATE_FROM_OCCLUSION
    ...
    inline val isEnabled
        get() = driveDreamStateFromOcclusion()
