...
@VolumePanelScope
class AncDeviceSettingAvailabilityCriteria
@Inject
constructor(private val interactor: AncDeviceSettingInteractor) : ComponentAvailabilityCriteria {

    override fun isAvailable(): Flow<Boolean> = interactor.getSetting().map { it != null }
}
