...
/** ViewModel for the "Power off" global action. */
class ShutdownGlobalActionViewModel
@AssistedInject
constructor(
    ...
    override val key = GlobalActionType.POWER
    ...
    override val state =
        GlobalActionUiState.Visible(
            ...
            icon =
                Icon.Resource(
                    resId = com.android.systemui.res.R.drawable.ic_global_actions_power_off,
                    contentDescription = null,
                ),
            textResId = R.string.global_action_power_off,
            onClick = {
                intents.trySend {
                    uiEventLogger.log(GlobalActionsEvent.GA_SHUTDOWN_PRESS)
                    interactor.shutdown()
                }
            },
            onLongClick = {
                uiEventLogger.log(GlobalActionsEvent.GA_SHUTDOWN_LONG_PRESS)
    ...
    @AssistedFactory
    interface Factory {
        fun create(): ShutdownGlobalActionViewModel
    }
}
