...
constructor(
    ...
    private suspend fun startRecording() {
        ...
        val hevc =
            recordDetailsParametersViewModel.isHevcAllowed &&
                recordDetailsParametersViewModel.hevc
        val startDelay =
            if (recordDetailsParametersViewModel.skipTimer) {
                NO_DELAY_MS.milliseconds
            } else {
...
private const val NO_DELAY_MS = 100L
