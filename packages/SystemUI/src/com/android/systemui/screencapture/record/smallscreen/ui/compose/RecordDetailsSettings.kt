...
fun RecordDetailsSettings(
    ...
    Surface(
        ...
        Column(
                        ...
                        items =
                            listOf(
                                RadioButtonGroupItem(
                                    label =
                                        stringResource(
                                            R.string.screenrecord_lowquality_high
                                        ),
                                    isSelected = parametersViewModel.lowQuality == 0,
                                    onClick = { parametersViewModel.setLowQuality(0) },
                                    contentDescription =
                                        stringResource(
                                            R.string.screenrecord_lowquality_high
                                        ),
                                ...
                                RadioButtonGroupItem(
                                    label =
                                        stringResource(
                                            R.string.screenrecord_lowquality_medium
                                        ),
                                    isSelected = parametersViewModel.lowQuality == 1,
                                    onClick = { parametersViewModel.setLowQuality(1) },
                                    contentDescription =
                                        stringResource(
                                            R.string.screenrecord_lowquality_medium
                                        ),
                                ...
                                RadioButtonGroupItem(
                                    label =
                                        stringResource(R.string.screenrecord_lowquality_low),
                                    isSelected = parametersViewModel.lowQuality == 2,
                                    onClick = { parametersViewModel.setLowQuality(2) },
                                    contentDescription =
                                        stringResource(
                                            R.string.screenrecord_lowquality_low
                                        ),
                                ),
                            ),
                    )
            ...
            RichSwitch(
                visible = parametersViewModel.isHevcAllowed,
                icon =
                    loadIcon(
                        viewModel = drawableLoaderViewModel,
