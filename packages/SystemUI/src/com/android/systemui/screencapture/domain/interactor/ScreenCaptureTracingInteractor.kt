...
@SysUISingleton
class ScreenCaptureTracingInteractor
@Inject
constructor(private val repository: ScreenCaptureTracingRepository) {

    fun beginVisibilityChangeSection(state: ScreenCaptureUiState) {
        repository.beginVisibilityChangeSection(state)
    }

    fun endVisibilityChangeSection(state: ScreenCaptureUiState) {
        repository.endVisibilityChangeSection(state)
    }
}
