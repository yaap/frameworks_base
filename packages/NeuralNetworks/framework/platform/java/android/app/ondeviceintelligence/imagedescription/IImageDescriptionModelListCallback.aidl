...
/**
 * Interface for receiving list of image description models.
 * @hide
 */
oneway interface IImageDescriptionModelListCallback {
    void onSuccess(in List<ImageDescriptionModel> result);
