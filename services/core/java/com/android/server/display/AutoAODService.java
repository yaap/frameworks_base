...
public class AutoAODService extends AutoSettingService {
    ...
    private final List<Uri> LISTEN_URIS = new ArrayList<>(List.of(
    ...
    public int getModeValue() {
        return Settings.Secure.getIntForUser(mContext.getContentResolver(),
                DOZE_ALWAYS_ON_AUTO_MODE, MODE_DISABLED, UserHandle.USER_CURRENT);
    }

    @Override
    public boolean getIsActive() {
        return Settings.Secure.getIntForUser(mContext.getContentResolver(),
                DOZE_ALWAYS_ON, OFF, UserHandle.USER_CURRENT) == 1;
    }
