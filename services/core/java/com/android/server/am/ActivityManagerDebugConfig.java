...
public class ActivityManagerDebugConfig {
    ...
    public static final boolean DEBUG_BACKUP = DEBUG_ALL || false;
    static final boolean DEBUG_BROADCAST = DEBUG_ALL || false;
    static final boolean DEBUG_BROADCAST_LIGHT = DEBUG_BROADCAST || false;
    static final boolean DEBUG_COMPACTION = DEBUG_ALL || false;
    static final boolean DEBUG_WRITEBACK = DEBUG_ALL || false;
    static final boolean DEBUG_FREEZER = DEBUG_ALL || false;
    public static final boolean DEBUG_LRU = DEBUG_ALL || false;
    static final boolean DEBUG_MU = DEBUG_ALL || false;
    static final boolean DEBUG_NETWORK = DEBUG_ALL || false;
    public static final boolean DEBUG_OOM_ADJ = DEBUG_ALL || false;
    public static final boolean DEBUG_OOM_ADJ_REASON = DEBUG_ALL || false;
    ...
    public static final boolean DEBUG_PSS = DEBUG_ALL || false;
    ...
    public static final boolean DEBUG_UID_OBSERVERS = DEBUG_ALL || false;
    public static final boolean DEBUG_USAGE_STATS = DEBUG_ALL || false;
