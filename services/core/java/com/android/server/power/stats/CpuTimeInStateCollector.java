 ...
 */
public class CpuTimeInStateCollector extends CpuPowerStatsCollector {
    private static final String TAG = "CpuTimeInStateCollector";
    ...
    CpuTimeInStateCollector(Injector injector) {
