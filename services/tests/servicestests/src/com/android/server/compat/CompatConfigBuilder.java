...
class CompatConfigBuilder {
    ...
    CompatConfigBuilder addEnableAfterSdkChangeWithIdAndDescription(int sdk, long id,
            String description) {
        mChanges.add(new CompatChange(id, "", sdk, -1, false, false, false, description, false));
        return this;
    }
    ...
    CompatConfigBuilder addEnableSinceSdkChangeWithIdNoLogging(int sdk, long id) {
        mChanges.add(new CompatChange(id, "", -1, sdk, false, false, true, "", false));
        return this;
    }
    ...
    CompatConfigBuilder addEnableSinceSdkChangeWithIdAndDescription(int sdk, long id,
            String description) {
        mChanges.add(new CompatChange(id, "", -1, sdk, false, false, false, description, false));
        return this;
    }
    ...
    CompatConfigBuilder addEnabledChangeWithIdAndDescription(long id, String description) {
        mChanges.add(new CompatChange(id, "", -1, -1, false, false, false, description, false));
        return this;
    }
    ...
    CompatConfigBuilder addDisabledChangeWithIdAndDescription(long id, String description) {
        mChanges.add(new CompatChange(id, "", -1, -1, true, false, false, description, false));
        return this;
    }
    ...
    CompatConfigBuilder addEnabledOverridableChangeWithId(long id) {
        mChanges.add(new CompatChange(id, "", -1, -1, false, false, false, "", true));
        return this;
    }

    CompatConfigBuilder addDisabledOverridableChangeWithId(long id) {
        mChanges.add(new CompatChange(id, "", -1, -1, true, false, false, "", true));
        return this;
    }
