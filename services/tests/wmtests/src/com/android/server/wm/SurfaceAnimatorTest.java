...
public class SurfaceAnimatorTest extends WindowTestsBase {
    ...
    public void testRunAnimation() {
        ...
        verify(mSpec).startAnimation(any(), any(), eq(ANIMATION_TYPE_WINDOW_ANIMATION),
                callbackCaptor.capture());

        callbackCaptor.getValue().onAnimationFinished(ANIMATION_TYPE_WINDOW_ANIMATION, mSpec);
        assertNotAnimating(mAnimatable);
        assertTrue(mAnimatable.mFinishedCallbackCalled);
        assertEquals(ANIMATION_TYPE_WINDOW_ANIMATION, mAnimatable.mFinishedAnimationType);
    ...
    public void testOverrideAnimation() {
        ...
        verify(mSpec2).startAnimation(any(), any(), eq(ANIMATION_TYPE_WINDOW_ANIMATION),
                callbackCaptor.capture());
        callbackCaptor.getValue().onAnimationFinished(ANIMATION_TYPE_WINDOW_ANIMATION, mSpec2);
        assertNotAnimating(mAnimatable);
        assertTrue(mAnimatable.mFinishedCallbackCalled);
        assertEquals(ANIMATION_TYPE_WINDOW_ANIMATION, mAnimatable.mFinishedAnimationType);
    }
    ...
    public void testDeferFinishDoNotFinishNextAnimation() {
        ...
        onFinishedCallback.onAnimationFinished(ANIMATION_TYPE_WINDOW_ANIMATION,
    ...
    public void testDeferFinishFromAdapter() {
        ...
        mAnimatable.mSurfaceAnimator.startAnimation(mTransaction, deferredFinishAdapter,
                true /* hidden */, ANIMATION_TYPE_WINDOW_ANIMATION);
        assertAnimating(mAnimatable);
        deferredFinishAdapter.mFinishCallback.onAnimationFinished(ANIMATION_TYPE_WINDOW_ANIMATION,
                deferredFinishAdapter);
