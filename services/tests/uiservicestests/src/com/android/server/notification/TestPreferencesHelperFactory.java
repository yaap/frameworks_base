...
public class TestPreferencesHelperFactory implements
        NotificationManagerService.PreferencesHelperFactory {

    @Override
    public PreferencesHelper newHelper(Context context, PackageManager pm,
        ...
        return new TestPreferencesHelper(context, pm, rankingHandler, zenHelper, permHelper,
