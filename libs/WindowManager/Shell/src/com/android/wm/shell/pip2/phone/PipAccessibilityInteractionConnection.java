...
public class PipAccessibilityInteractionConnection implements
    ...
    public interface AccessibilityCallbacks {
        /**
         * AccessibilityShowMenu callback.
         */
    ...
    private boolean mWaitingToApplyScheduledBoundsChange;
    ...
    public PipAccessibilityInteractionConnection(Context context,
            ...
            PipSnapAlgorithm snapAlgorithm, PipTransitionState pipTransitionState,
            PipScheduler pipScheduler, PipSurfaceTransactionHelper pipSurfaceTransactionHelper,
            AccessibilityCallbacks callbacks, Runnable unstashCallback,
    ...
    /**
     * Set the PipAccessibilityInteractionConnection to AccessibilityManager
     * @param am AccessibilityManager
     */
    ...
    private void scheduleBounds() {
        ...
        mPipTransitionState.setOnIdlePipTransitionStateRunnable(() -> {
            ...
            extra.putParcelable(A11Y_SCHEDULED_PIP_BOUNDS, toBounds);
    ...
    @Override
    public void onPipTransitionStateChanged(int oldState, int newState, @Nullable Bundle extra) {
        switch (newState) {
            case PipTransitionState.SCHEDULED_BOUNDS_CHANGE:
                final Rect toBounds =
                        extra.getParcelable(A11Y_SCHEDULED_PIP_BOUNDS, Rect.class);
                mWaitingToApplyScheduledBoundsChange = toBounds != null;
                if (mWaitingToApplyScheduledBoundsChange) {
            ...
            case PipTransitionState.CHANGING_PIP_BOUNDS:
                ...
                mWaitingToApplyScheduledBoundsChange = false;
