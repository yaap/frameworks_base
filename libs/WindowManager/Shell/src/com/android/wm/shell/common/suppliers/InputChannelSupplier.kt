...
/**
 * An Injectable [Supplier<InputChannel>].
 *
 * This can be used in place of kotlin default parameters values [builder = ::InputChannel] which
 * requires the [@JvmOverloads] annotation to make this available in Java.
 *
