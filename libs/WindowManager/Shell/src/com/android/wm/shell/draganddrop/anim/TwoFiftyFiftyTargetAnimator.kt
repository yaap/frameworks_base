 ...
 *
 * NOTE: Naming convention for many variables is done as "hXtYZ" This means that variable is a
 * transformation on the Z property for target index Y while the user is hovering over target index
 * X. Ex: h1t2scaleX=2 => User is hovering over target index 1, target index 2 should scaleX by 2
 *
...
class TwoFiftyFiftyTargetAnimator : DropTargetAnimSupplier {
    /**
     * TODO: Could we transpose all the horizontal rects by 90 degrees and have that suffice for top
     *   bottom split?? Hmmm... Doubt it.
     */
    override fun getTargets(
        ...
        val dividerWidth: Float =
            resources.getDimensionPixelSize(R.dimen.split_divider_bar_width).toFloat()
        ...
        val h0t0HoverProps =
            HoverAnimProps(
                targets.get(0),
                h0t0TransX,
                farStartBounds.top.toFloat(),
                h0t0ScaleX,
                1f,
                Rect(0, 0, (stageWidth + dividerWidth).toInt(), farStartBounds.bottom),
            )
        ...
        val h0t1HoverProps =
            HoverAnimProps(
                ...
                h0t1ScaleX,
                1f,
                Rect(stageWidth, 0, (stageWidth + h0t1TransX).toInt(), farStartBounds.bottom),
            )
        ...
        val h0t2HoverProps =
            HoverAnimProps(
                ...
                1f,
                Rect(
                    displayRegion.right as Int - endsWidth,
                    0,
        ...
        val h1t0HoverProps =
            HoverAnimProps(
                ...
                h1t0ScaleX,
                1f,
                Rect(0, 0, (farStartBounds.width() + dividerWidth).toInt(), farStartBounds.bottom),
            )
        ...
        val h2t1HoverProps =
            HoverAnimProps(
                ...
                h2t1ScaleX,
                1f,
                Rect(startBounds.left, 0, (startBounds.left + stageWidth), farStartBounds.bottom),
            )
        ...
        val h2t3HoverProps =
            HoverAnimProps(
                ...
                h2t3ScaleX,
                1f,
                Rect(endBounds.right, 0, displayRegion.right, farStartBounds.bottom),
            )
        ...
        val h3t1HoverProps =
            HoverAnimProps(
                ...
                h3t1ScaleX,
                1f,
                Rect(0, 0, endsWidth, farStartBounds.bottom),
            )
        ...
        val h3t3HoverProps =
            HoverAnimProps(
                ...
                1f,
                Rect(
                    displayRegion.right - stageWidth,
                    0,
                    displayRegion.right,
                    farStartBounds.bottom,
                ),
        ...
        return Pair(
            targets,
            listOf(
                animPropsForHoverTarget0,
                animPropsForHoverTarget1,
                animPropsForHoverTarget2,
                animPropsForHoverTarget3,
            ),
        )
    }
}
