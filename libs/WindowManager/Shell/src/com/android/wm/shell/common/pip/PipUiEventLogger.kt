...
class PipUiEventLogger(
    ...
    private fun getUid(packageName: String, userId: Int): Int {
        ...
        try {
            uid =
                mPackageManager
                    .getApplicationInfoAsUser(packageName, 0 /* ApplicationInfoFlags */, userId)
                    .uid
    ...
    enum class PipUiEventEnum(private val mId: Int) : UiEventLogger.UiEventEnum {
        @UiEvent(doc = "Activity enters picture-in-picture mode") PICTURE_IN_PICTURE_ENTER(603),
        ...
        @UiEvent(doc = "Shows picture-in-picture menu") PICTURE_IN_PICTURE_SHOW_MENU(607),
        @UiEvent(doc = "Hides picture-in-picture menu") PICTURE_IN_PICTURE_HIDE_MENU(608),
        @UiEvent(
            doc =
                "Changes the aspect ratio of picture-in-picture window. This is inherited" +
        ...
        @UiEvent(doc = "User unstashed picture-in-picture") PICTURE_IN_PICTURE_STASH_UNSTASHED(709),
