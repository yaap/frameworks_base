 ...
 * creation of independent container-hierarchy shell components that are not created as a part of
 * the dependencies for interfaces passed to SysUI.
 *
...
public @interface ContainerHierarchyCreateTriggerOverride {
}
