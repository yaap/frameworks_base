...
@Postsubmit
class SnapResizeAppWindowLeftWithButtonFlickerTest(flicker: FlickerTest) :
    DesktopModeBaseTest(flicker) {

    inner class SnapResizeAppWindowLeftWithButtonScenario :
        SnapResizeAppWindowWithButton(toLeft = true, rotation = flicker.scenario.startRotation)
