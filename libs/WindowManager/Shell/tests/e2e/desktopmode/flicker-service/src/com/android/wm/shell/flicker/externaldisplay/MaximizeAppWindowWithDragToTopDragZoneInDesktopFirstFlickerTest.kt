...
/**
 * Maximize app window by dragging it to the top drag zone in desktop-first display when an external
 * display is connected. Test with 3 button navigation because the expected bottom inset of the
 * stable bounds is higher than actual.
 *
...
class MaximizeAppWindowWithDragToTopDragZoneInDesktopFirstFlickerTest(flicker: FlickerTest) :
    ...
    override val transition: FlickerBuilder.() -> Unit
        get() = {
            ...
            transitions { scenario.maximizeAppWithDragToTopDragZone() }
