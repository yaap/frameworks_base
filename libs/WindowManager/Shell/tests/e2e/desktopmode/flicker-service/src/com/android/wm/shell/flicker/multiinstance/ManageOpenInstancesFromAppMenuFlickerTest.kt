...
/** Test for managing open instances from the app menu in Desktop Mode. */
@RequiresDesktopDevice
@Postsubmit
@RunWith(Parameterized::class)
@Parameterized.UseParametersRunnerFactory(FlickerParametersRunnerFactory::class)
class ManageOpenInstancesFromAppMenuFlickerTest(flicker: FlickerTest) :
    ...
    override val transition: FlickerBuilder.() -> Unit
        get() = {
            ...
            transitions { scenario.triggerFromAppMenu() }
