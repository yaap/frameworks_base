...
class ExitDesktopToFullScreenWithKeyboardShortcutFlickerTest(flicker: FlickerTest) :
    ...
    inner class ExitDesktopToFullScreenWithKeyboardShortcutScenario :
        ExitDesktopFromKeyboardShortcut(flicker.scenario.startRotation)
    ...
    override val transition: FlickerBuilder.() -> Unit
        get() = {
            ...
            transitions { scenario.exitDesktopToFullScreenFromKeyboardShortcut() }
