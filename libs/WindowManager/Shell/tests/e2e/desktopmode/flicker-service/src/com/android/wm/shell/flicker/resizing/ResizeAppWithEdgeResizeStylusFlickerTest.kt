...
/**
 * Resize an app to increase its size through its right edge using a stylus.
 *
...
@Postsubmit
class ResizeAppWithEdgeResizeStylusFlickerTest(flicker: FlickerTest) :
    DesktopModeBaseTest(flicker) {
    inner class ResizeAppWithEdgeResizeStylusScenario :
        ResizeAppWithEdgeResize(
            MotionEventHelper.InputMethod.STYLUS,
    ...
    val scenario = ResizeAppWithEdgeResizeStylusScenario()
