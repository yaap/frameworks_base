...
/**
 * Base scenario test for switch between desktop app and full screen app, triggered via overview.
 */
@Ignore("Base Test Class")
abstract class SwitchBetweenDesktopAndFullScreenViaOverview(
