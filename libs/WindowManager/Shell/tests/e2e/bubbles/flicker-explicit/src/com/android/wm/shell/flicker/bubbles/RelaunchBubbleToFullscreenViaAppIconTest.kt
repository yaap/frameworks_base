...
/**
 * Test relaunching a bubbled app to fullscreen via its app icon.
 *
 * To run this test: `atest WMShellFlickerTestsBubbles:RelaunchBubbleToFullscreenViaAppIconTest`
 *
 * Pre-steps:
 * ```
 ...
 * Actions:
 * ```
 *     Relaunch the test app from the app launcher icon in all apps.
 * ```
 *
 * Verified tests:
...
@Presubmit
class RelaunchBubbleToFullscreenViaAppIconTest :
    ...
    companion object {
        private val recordTraceWithTransitionRule =
            RecordTraceWithTransitionRule(
                ...
                transition = {
                    // Relaunch [testApp] from app launcher icon in all apps.
