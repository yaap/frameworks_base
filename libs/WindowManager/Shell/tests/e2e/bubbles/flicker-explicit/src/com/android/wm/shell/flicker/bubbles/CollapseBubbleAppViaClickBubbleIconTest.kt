...
/**
 * Test collapse bubble app via clicking on the bubble icon of the expanded Task.
 *
 * To run this test:
 * ```
 *     atest WMShellExplicitFlickerTestsBubbles:CollapseBubbleAppViaClickBubbleIconTest
 * ```
 *
 * Pre-steps:
 * ```
 ...
 * Actions:
 * ```
 *     Collapse bubbled [testApp] via clicking on the bubble icon of the expanded Task.
 * ```
 *
 * Verified tests:
...
class CollapseBubbleAppViaClickBubbleIconTest(navBar: NavBar) :
