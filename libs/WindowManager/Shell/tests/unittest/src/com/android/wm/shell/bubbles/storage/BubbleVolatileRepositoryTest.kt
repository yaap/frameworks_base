...
class BubbleVolatileRepositoryTest : ShellTestCase() {
    ...
    fun testAddBubbles() {
        ...
        verify(launcherApps)
            .cacheShortcuts(
                eq(PKG_MESSENGER),
                eq(listOf("shortcut-1", "shortcut-2")),
                eq(user0),
    ...
    fun testAddBubbleMatchesByKey() {
        val bubble =
            BubbleEntity(0, "com.example.pkg", "shortcut-id", "key", 120, 0, "title", 1, null)
        ...
        val bubbleModified =
            BubbleEntity(0, "com.example.pkg", "shortcut-id", "key", 120, 0, "different title", 2)
    ...
    fun testSanitizeBubbles_noChanges() {
        ...
        val ret =
            repository.sanitizeBubbles(
                listOf(user0.identifier, user10_managed.identifier, user11.identifier)
            )
        assertThat(ret).isFalse() // bubbles were NOT removed
