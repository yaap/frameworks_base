...
public class SplitPermissionInfoParcelable implements Parcelable {
    ...
    /**
     * The feature flag that gates this split permission.
     */
    @Nullable
    private final String mFeatureFlag;

    /**
     * Whether the feature flag is negated.
     */
    private final boolean mFeatureFlagNegated;
    ...
    public SplitPermissionInfoParcelable(
        ...
        this.mFeatureFlagNegated = featureFlagNegated;
    ...
    public boolean equals(@Nullable Object o) {
        ...
        return true
                ...
                && mFeatureFlagNegated == that.mFeatureFlagNegated;
    }
    ...
    public int hashCode() {
        ...
        _hash = 31 * _hash + Objects.hashCode(mFeatureFlag);
        _hash = 31 * _hash + Boolean.hashCode(mFeatureFlagNegated);
        return _hash;
    }
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        byte flg = 0;
        if (mFeatureFlagNegated) flg |= 0x10;
        if (mFeatureFlag != null) flg |= 0x8;
        dest.writeByte(flg);
        dest.writeString(mSplitPermission);
        dest.writeStringList(mNewPermissions);
        dest.writeInt(mTargetSdk);
        if (mFeatureFlag != null) dest.writeString(mFeatureFlag);
    }
    ...
    protected SplitPermissionInfoParcelable(@NonNull Parcel in) {
        ...
        boolean featureFlagNegated = (flg & 0x10) != 0;
        ...
        String featureFlag = (flg & 0x8) == 0 ? null : in.readString();
