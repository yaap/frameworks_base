...
/**
 * Interface for a virtual navigation toucpad. Provides APIs for the caller to inject touch input
 * events to the device, by calling the system server.
 *
 * @hide
 */
interface IVirtualNavigationTouchpad {
    ...
    /**
     * Injects a virtual touchpad touch event.
     */
    @RequiresNoPermission
