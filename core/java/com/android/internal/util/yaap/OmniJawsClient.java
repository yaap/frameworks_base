...
public class OmniJawsClient {
    ...
    public static boolean isOmniJawsServiceInstalled(Context context) {
        return isAvailableApp(context, SERVICE_PACKAGE);
    }

    public static boolean isOmniJawsEnabled(Context context) {
    ...
    private static boolean isAvailableApp(Context context, String pkg) {
        try {
    ...
    private static Drawable getDefaultConditionImage(Context context) {
        try {
