...
public class SystemNotificationChannels {
    ...
    public static final String DEVELOPER_IMPORTANT = "DEVELOPER_IMPORTANT_1";
    public static final String DEVELOPER_IMPORTANT_OLD = "DEVELOPER_IMPORTANT";
    ...
    public static final String USB = "USB_1";
    public static final String USB_OLD = "USB";
