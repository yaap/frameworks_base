...
oneway interface IInputMethodPrivilegedOperations {
    ...
    void hideMySoftInput(in ImeTracker.Token statsToken, in AndroidFuture future /* T=Void */);
    void showMySoftInput(in ImeTracker.Token statsToken, in AndroidFuture future /* T=Void */);
