...
import static com.android.internal.widget.remotecompose.core.operations.utilities.touch.CommandParameters.PA_FLOAT;
import static com.android.internal.widget.remotecompose.core.operations.utilities.touch.CommandParameters.PA_INT;
import static com.android.internal.widget.remotecompose.core.operations.utilities.touch.CommandParameters.param;
...
import com.android.internal.widget.remotecompose.core.operations.utilities.touch.CommandParameters;
...
public class TextStyle extends Operation implements ComponentData {
    ...
    @Nullable int [] mFontAxis;
    @Nullable float [] mFontAxisValues;
    ...
    public TextStyle(int id, @Nullable Integer color, @Nullable Integer colorId,
            ...
            @Nullable Boolean underline, @Nullable Boolean strikethrough, @Nullable int [] fontAxis,
            @Nullable float [] fontAxisValues, @Nullable Boolean autosize,
    ...
    public TextStyle(int id, int color, int colorId, float fontSize, float minFontSize,
            ...
            @Nullable int [] fontAxis, @Nullable float [] fontAxisValues, boolean autosize) {
    ...
    public static void apply(@NonNull WireBuffer buffer, int id, @Nullable Integer color,
            ...
            @Nullable Boolean strikethrough, @Nullable int [] fontAxis,
            @Nullable float [] fontAxisValues, @Nullable Boolean autosize,
            @Nullable Integer parentId) {
    ...
    public static void read(@NonNull WireBuffer buffer, @NonNull List<Operation> operations) {
        ...
        for (int i = 0; i < paramsLength; i++) {
            PARAMETERS.read(buffer, new CommandParameters.Callback() {
                ...
                @Override
                public void value(int id, @NonNull int [] value) {
                    if (id == P_FONT_AXIS) {
                        for (int axis : value) {
                ...
                @Override
                public void value(int id, @NonNull float [] value) {
